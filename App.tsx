...
import { Download, LogOut, Calendar as CalendarIcon, ChevronLeft } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleTogglePaid = (booking: Booking) => {
    ...
    if (detailBooking?.id === booking.id) setDetailBooking(updatedBooking);
    ...
    <div className="min-h-screen bg-slate-50 pb-24 sm:pb-12 font-sans">
      ...
      <header className="bg-white border-b sticky top-0 z-40 px-4 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div><h1 className="text-xl font-black leading-none">이끌림 에어컨</h1></div>
        </div>
